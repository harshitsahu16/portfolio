      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center '>
        <div>
            <h1 className='py-4 text-gray-700'>
                Hi, I'm <span className='text-[#5651e5]'>Harshit Sahu</span>
            </h1>
            ...
            <a
              ...
              rel='noreferrer'
            >
                <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:bg-blue-500 hover:scale-110 ease-in duration-300'>
                    <FaLinkedinIn />
                </div>
                </a>
                <a
            ...
            >
                ...
                <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:bg-red-700 hover:scale-110 ease-in duration-300'>
                    <AiOutlineMail />
                </div>
                </a>
                <a target='_blank' href="https://drive.google.com/file/d/12l0h2NW7T2sSCivri-t7ZC7n48gg5gfl/view?usp=share_link">
                <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:bg-violet-700 hover:scale-110 ease-in duration-300'>
